...
| `yaml/` | Benchmark and solution YAMLs: `gemm_partial_rms_k1.yaml`, `gemm_partial_rms_k1_rowmajor.yaml`, `gemm_rstdscale_k3.yaml`, `gemm_rstdscale_k3_sweep.yaml`, `tune_all_epilogues.yaml`, `tune_all_epilogues_fast.yaml`, `tune_gemm_variants.yaml`, `tune_subtile_bf16_prms_8192.yaml`, `tune_subtile_bf16_prmsq_8192.yaml`, `debug_prmsq_single.yaml`. |
