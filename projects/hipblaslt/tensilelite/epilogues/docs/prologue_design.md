...
The existing `PartialRMS` and `RstdScale` epilogues are injected in `KernelWriter.py` at
lines 5199–5209 after the main loop completes:
...
| PartialRMS / RstdScale epilogue injection | `Tensile/KernelWriter.py` | 5199–5209 |
