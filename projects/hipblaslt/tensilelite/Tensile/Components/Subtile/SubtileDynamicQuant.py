...
class SubtileDynamicQuant:
    ...
    def _mulVgprBySgprConst(self, module, dstVgpr: int, sgprName: str,
        ...
        if const > 0 and (const & (const - 1)) == 0:
            ...
            return
        module.add(VMulLOU32(dst=vgpr(dstVgpr), src0=sgpr(sgprName), src1=const, comment=comment))
    ...
    def _shiftOrMulVgprConst(self, module, dst: int, srcVgpr: int,
        ...
        if const > 0 and (const & (const - 1)) == 0:
            ...
            return
        module.add(VMulLOU32(dst=vgpr(dst), src0=vgpr(srcVgpr), src1=const, comment=comment))
